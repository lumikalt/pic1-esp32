...
// ------------------- WI-FI -------------------
// IMPORTANT : lines 27 and 28 need to be changed to the hotspot used to program both ESPs as well as when you want the pocket cube functional
const char* ssid     = "CW";
